...
class ImageController
{
		...
		$imageTransformer = "{$modelClass}Transformer";
		...
		return ($insert['code']==200) ? $imageTransformer->transform($insert, $data) : $insert;
	...
	public function update($data){
		...
		return ($update['code']==200) ? $imageTransformer->transform($update, $data) : $update;
	...
	public function delete($data){
		...
		return ($delete['code']==200) ? $imageTransformer->transform($delete, $data) : $delete;
	...
	public function retrieve($data){
		...
		return ($retrieve['code']==200) ? $imageTransformer->transform($retrieve, $data) : $retrieve;
