...
class ProductController
{
	...
	public function insert($data){
		...
		$productTransformer = "{$modelClass}Transformer";
		...
		return ($insert['code']==200) ? $productTransformer->transform($insert, $data) : $insert;
	...
	public function update($data){
		...
		return ($update['code']==200) ? $productTransformer->transform($update, $data) : $update;
	...
	public function delete($data){
		...
		return ($delete['code']==200) ? $productTransformer->transform($delete, $data) : $delete;
	...
	public function retrieve($data){
		...
		return ($retrieve['code']==200) ? $productTransformer->transform($retrieve, $data) : $retrieve;
