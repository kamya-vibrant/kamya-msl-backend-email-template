...
class OptionController
{
	...
	public function insert($data){
		...
		$optionTransformer = "{$modelClass}Transformer";
		$optionTransformer = new $optionTransformer();

		$query = $QueryTransformer->prepareQuery($data);

		$insert = $model->insert($query);

		return ($insert['code']==200) ? $optionTransformer->transform($insert, $data) : $insert;
	...
	public function update($data){
		...
		return ($update['code']==200) ? $optionTransformer->transform($update, $data) : $update;
	...
	public function delete($data){
		...
		return ($delete['code']==200) ? $optionTransformer->transform($delete, $data) : $delete;
	...
	public function retrieve($data){
		...
		return ($retrieve['code']==200) ? $optionTransformer->transform($retrieve, $data) : $retrieve;
	...
	public function customQuery($data) {
		...
		switch($data['method']):
			...
			case 'getOptionInById':
				$sql = "SELECT * from option WHERE id in (" . $data['optionIds'] .")";
			break;
