...
class IngredientController
{
	...
	public function insert($data){
		...
		$ingredientTransformer = "{$modelClass}Transformer";
		$ingredientTransformer = new $ingredientTransformer();

		$query = $QueryTransformer->prepareQuery($data);

		$insert = $model->insert($query);

		return ($insert['code']==200) ? $ingredientTransformer->transform($insert, $data) : $insert;
	...
	public function update($data){
		...
		return ($update['code']==200) ? $ingredientTransformer->transform($update, $data) : $update;
	...
	public function delete($data){
		...
		return ($delete['code']==200) ? $ingredientTransformer->transform($delete, $data) : $delete;
	...
	public function retrieve($data){
		...
		return ($retrieve['code']==200) ? $ingredientTransformer->transform($retrieve, $data) : $retrieve;
	...
	public function customQuery($data){
		...
		switch($data['method']):
			...
			case 'getIngredientInById':
					$sql = "SELECT * from ingredient WHERE id in (" . $data['ingredientIds'] .")";
				break;
